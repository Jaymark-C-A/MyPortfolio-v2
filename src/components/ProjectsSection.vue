      ...
      <div class="container-fluid mb-2">
        <div class="row">
          <div class="col-lg-12 p-0">
            <img src="/public/img/front.png" alt="front" class="rounded-4" width="100%" height="auto" style="border:1px solid #f8f9fa;">
          </div>
        </div>
      </div>
      ...
      <div :class="[containerClass, 'container-fluid','project',' bg-light','rounded-4','mb-2']">
        <div class="row p-3 p-lg-2">
          ...
          <div class="col-lg-6 p-0 px-lg-4 pt-2">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex justify-content-start gap-2">
                  <a href="https://github.com/Jaymark-C-A/Simple_landingPage"  :class="[containerClass, 'btn','py-0','px-4']" style="color: #000;"><i class="fab fa-github"></i></a>
                  <a href="https://vinland-three.vercel.app/" :class="[containerClass, 'btn','py-0','px-4']" style="color: #000;"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                </div>
